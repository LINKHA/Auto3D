...
public:
    ...
    float AbsDotProduct(const Vector3& rhs) const { return Auto3D::Abs(x * rhs.x) + Auto3D::Abs(y * rhs.y) + Auto3D::Abs(z * rhs.z); }
    ...
    bool Equals(const Vector3& rhs) const { return Auto3D::Equals(x, rhs.x) && Auto3D::Equals(y, rhs.y) && Auto3D::Equals(z, rhs.z); }
