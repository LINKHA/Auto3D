...
HDREquirectangular::HDREquirectangular()
	...
	, prefilterShader(AtConfig::shader_path + "au_pbr_cubemap.auvs"
		, AtConfig::shader_path + "au_pbr_prefilter.aufs")
	, brdfShader(AtConfig::shader_path + "au_pbr_brdf.auvs"
		, AtConfig::shader_path + "au_pbr_brdf.aufs")
...
void HDREquirectangular::renderSphere()
{
	if (sphereVAO == 0)
	{
...
void HDREquirectangular::renderCube()
{
...
void HDREquirectangular::renderQuad()
{
	if (quadVAO == 0)
	{
		float quadVertices[] = {
