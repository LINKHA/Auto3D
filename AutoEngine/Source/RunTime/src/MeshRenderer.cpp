...
//}
//MeshRenderer::MeshRenderer(Ambient* ambient,char* meshPath)
//	: Super(ambient)
//	, _shader(Shader(shader_path + "au_light_map_model_loading.auvs"
//		, shader_path + "au_light_map_model_loading.aufs"))
//	, _isUserShader(false)
...
//	_modelPath = meshPath;
//}
//MeshRenderer::MeshRenderer(Ambient* ambient,char* meshPath, const Shader& shader)
//	: Super(ambient)
//	, _shader(shader)
//	, _isUserShader(true)
//{
...
//
//
//void MeshRenderer::SetModel(char* modelPath)
//{
