...
//	*/
//	void AddResourceDir(const WSTRING& path, unsigned priority = PRIORITY_LAST);
//	/**
//	* @brief : Get resource paths
//	*/
//	VECTOR<WSTRING> GetResourceDirs();
//	/**
//	* @brief : Return added resource load directories
//	*/
//	const VECTOR<WSTRING>& GetResourceDirs() const { return _resourceDirs; }
//	/**
