...
void TextureParallax::Start()
{
	...
	_timage = GetSubSystem<ResourceSystem>()->TextureLoad((dir +"texture/bricks.jpg").CStr());
	_imageNormal = GetSubSystem<ResourceSystem>()->TextureLoad((dir + "texture/bricks_normal.jpg").CStr());
	_imageParallax = GetSubSystem<ResourceSystem>()->TextureLoad((dir + "texture/bricks_disp.jpg").CStr());
...
void TextureParallax::Draw()
{
	...
	glBindTexture(GL_TEXTURE_2D, _imageParallax);
