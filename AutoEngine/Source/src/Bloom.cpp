...
void Bloom::Start()
{
	...
	woodTexture = GetSubSystem<ResourceSystem>()->TextureLoad((dir + "texture/bricks.jpg").CStr());
	containerTexture = GetSubSystem<ResourceSystem>()->TextureLoad((dir + "texture/wood.jpg").CStr());
