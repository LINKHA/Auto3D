...
// shaderc -f D:\Auto3D\SampleProject\16-shadowmaps\vs_shadowmaps_color_lighting_linear_omni_i.sc -o D:\Auto3D\Bin\Data\Shaders\dx11\vs_shadowmaps_color_lighting_linear_omni_i.bin --depends -i D:\Auto3D\Auto3D\ThirdParty\bgfx\bgfx\src --varyingdef D:\Auto3D\SampleProject\16-shadowmaps\varying.def.sc --platform windows -p vs_4_0 -O 3 --type vertex -O3 --debug -O 0
...
_varying_.v_position = mul(u_lightMtx, posOffset);
_varying_.v_texcoord1 = mul(u_shadowMapMtx0, _varying_.v_position);
_varying_.v_texcoord2 = mul(u_shadowMapMtx1, _varying_.v_position);
_varying_.v_texcoord3 = mul(u_shadowMapMtx2, _varying_.v_position);
_varying_.v_texcoord4 = mul(u_shadowMapMtx3, _varying_.v_position);
