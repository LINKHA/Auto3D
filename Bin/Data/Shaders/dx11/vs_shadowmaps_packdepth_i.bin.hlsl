...
Output main( float3 a_position : POSITION) { Output _varying_; _varying_.v_position = float4(0.0, 0.0, 0.0, 0.0);;
{
_varying_.gl_Position = mul(u_modelViewProj, float4(a_position, 1.0) );
_varying_.v_position = _varying_.gl_Position;
} return _varying_;
}
