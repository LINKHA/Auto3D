...
Output main( float3 a_position : POSITION , float4 i_data0 : TEXCOORD7 , float4 i_data1 : TEXCOORD6 , float4 i_data2 : TEXCOORD5 , float4 i_data3 : TEXCOORD4) { Output _varying_;
{
float4x4 model;
model[0] = i_data0;
model[1] = i_data1;
