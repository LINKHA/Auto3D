...
// shaderc_test -f D:\Auto3D\SampleProject\16-shadowmaps\vs_shadowmaps_packdepth_linear_i.sc -o D:\Auto3D\Bin\Data\Shaders\dx11\vs_shadowmaps_packdepth_linear_i.bin --depends -i D:\Auto3D\Auto3D\ThirdParty\bgfx\bgfx\src --varyingdef D:\Auto3D\SampleProject\16-shadowmaps\varying.def.sc --platform windows -p vs_4_0 -O 3 --type vertex -O3 --debug -O 0
...
Output main( float3 a_position : POSITION) { Output _varying_; _varying_.v_depth = 0.0;;
{
_varying_.gl_Position = mul(u_modelViewProj, float4(a_position, 1.0) );
_varying_.v_depth = _varying_.gl_Position.z * 0.5 + 0.5;
} return _varying_;
}
