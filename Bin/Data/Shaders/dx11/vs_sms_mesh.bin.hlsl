...
// shaderc_test -f D:\Project\MyProject\Auto3D\SampleProject\15-shadowmaps-simple\vs_sms_mesh.sc -o D:\Project\MyProject\Auto3D\Bin\Data\Shaders\dx11\vs_sms_mesh.bin --depends -i D:\Project\MyProject\Auto3D\Auto3D\ThirdParty\bgfx\bgfx\src --varyingdef D:\Project\MyProject\Auto3D\SampleProject\15-shadowmaps-simple\varying.def.sc --platform windows -p vs_4_0 -O 3 --type vertex -O3 --debug -O 0
...
{
float4x4 lightMtx = mul(u_shadowMtx, u_model[0]);
